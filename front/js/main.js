(function () {
    ...
    function refreshBetInfo(userId) {
        ...
        const matchNumber = Number(document.querySelector(".predict__tabs-date.active").getAttribute("data-match-number"));
    ...
    function handleTabClick(event) {
        ...
        let currentMatch = Number(clickedTab.getAttribute("data-match-number"))
    ...
    function updateContainers() {
        ...
        const isDate3Active = document.querySelector('.predict__tabs-date.date3.active');
